...
public class KeyManage {
    ...
    public static String[] getScreenNames(final String prefix, final String suffix) { // , final boolean addAllAccount) {
        ...
        if (pref_debug_write_logcat) Log.i("Yumura", "getAll");
